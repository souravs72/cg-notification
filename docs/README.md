...
| Doc | Purpose |
|-----|---------|
| [01-architecture](01-architecture.md) | Overview, modules, message flow, topics, DB ownership |
| [02-invariants-and-rules](02-invariants-and-rules.md) | Tenant/provider/Kafka/credential/retry rules |
