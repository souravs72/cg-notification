...
/**
 * WhatsApp session entity for whatsapp-worker module.
 * 
 * ⚠️ READ-ONLY PROJECTION: This entity is a read-only projection used ONLY for credential resolution.
 * 
 * Ownership and responsibilities:
 * - Schema ownership: notification-api module owns the whatsapp_sessions table schema
 * - Write operations: All writes (create, update, delete) happen in notification-api module
 * - Lifecycle management: Session creation, connection, and updates are handled by notification-api
 * - Usage in whatsapp-worker: This projection is used ONLY to read sessionApiKey for message delivery
 * 
 ...
 * 
 * IMPORTANT: If you modify this entity, ensure WhatsAppSession in notification-api
